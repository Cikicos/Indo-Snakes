...
.container {
  ...
  background-image: url('/img/bgregisc.jpg');
...
.overlay {
  background: -webkit-linear-gradient(#7bd17d, #519c52);
  background: linear-gradient(#7bd17d, #519c52);
  opacity: 0.70;
...
@media (max-width: 500px) {
  ...
  <title>IndoSnakes register</title>
</head>
<body>
...
<div class='container'>
  <div class='window'>
    ...
    <div class='content'>
      ...
      <div class="back-to" style="text-align: center">
				 Have an account?<a href="/">Click Here</a>
				</div>
      <div> 
      <button  type="submit" class='ghost-round full-width'><b>Create Account</b></button>
      </div>
      </form>
